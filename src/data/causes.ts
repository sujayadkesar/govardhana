...
export const causes: Cause[] = [
  // ---------- mark an occasion ----------
  {
    ...
    image: '/images/causes/gopooja.jpg',
    group: 'occasion',
    order: 1,
  ...
  },
  {
    ...
    image: '/images/causes/goshala.jpg',
    group: 'occasion',
    order: 3,
  ...
  // ---------- project ----------
  {
    ...
    image: '/images/causes/construction.jpg',
    group: 'project',
    order: 13,
