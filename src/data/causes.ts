...
export const causes: Cause[] = [
  // ---------- mark an occasion ----------
  {
    ...
    image: '/images/causes/gopooja.webp',
    group: 'occasion',
    order: 1,
  ...
  },
  {
    ...
    image: '/images/causes/goshala.webp',
    group: 'occasion',
    order: 3,
  ...
  },
  {
    ...
    image: '/images/causes/nandi.webp',
    group: 'adopt',
    order: 6,
  ...
  },
  {
    ...
    image: '/images/causes/grass.webp',
    group: 'feed',
    order: 11,
  ...
  // ---------- project ----------
  {
    ...
    image: '/images/causes/construction.webp',
    group: 'project',
    order: 13,
